          ...
          ? {
              ...
              metrics: {
                ...
                right_arm: {
                  ...
                  body_fat: {
                    measure_evolution: getRemainingPercentageFromMeasures(
                      firstMeasure.metrics.right_arm.body_fat.measure_value as number, 
                      lastMeasure.metrics.right_arm.body_fat.measure_value as number
                    ),
                  },
                  muscle_quality: {
                    measure_evolution: getRemainingPercentageFromMeasures(
                      firstMeasure.metrics.right_arm.muscle_quality.measure_value as number, 
                ...
                left_leg: {
                  ...
                  body_fat: {
                    measure_evolution: getRemainingPercentageFromMeasures(
                      firstMeasure.metrics.left_leg.body_fat.measure_value as number, 
                      lastMeasure.metrics.left_leg.body_fat.measure_value as number
                    ),
                  },
                  muscle_quality: {
                    measure_evolution: getRemainingPercentageFromMeasures(
                      firstMeasure.metrics.left_leg.muscle_quality.measure_value as number, 
                ...
                right_leg: {
                  ...
                  body_fat: {
                    measure_evolution: getRemainingPercentageFromMeasures(
                      firstMeasure.metrics.right_leg.body_fat.measure_value as number, 
                      lastMeasure.metrics.right_leg.body_fat.measure_value as number
                    ),
                  },
                  muscle_quality: {
                    measure_evolution: getRemainingPercentageFromMeasures(
                      firstMeasure.metrics.right_leg.muscle_quality.measure_value as number, 
                ...
                trunk: {
                  ...
                  body_fat: {
                    measure_evolution: getRemainingPercentageFromMeasures(
                      firstMeasure.metrics.trunk.body_fat.measure_value as number, 
                ...
                circumferenceShoulders: {
                  measure_evolution: getRemainingPercentageFromMeasures(
                    firstMeasure?.metrics?.circumferenceShoulders?.measure_value as number, 
